		...
		<section class="main">
				...
				<div class="row users">
					...
					<div class="col-8 card">
						...
						<form action="<%=request.getContextPath()%>/restaurantServlet" method="POST">
						
							<div class="mb-3">
								<label for="exampleFormControInput1" class="form-label">名稱</label>
							...
							<div class="mb-3"><label for="exampleFormControInput1" class="form-label">說明</label>
								<input type="text" class="form-control" id="exampleFormControInput1" 
									placeholder="說明" name="rDescription"
									value="<%=request.getParameter("rDescription")%>" />
							</div>
							...
							<div class="mb-3">
								<label for="exampleFormControInput1" class="form-label">電話</label>
								<input type="text" class="form-control"
									id="exampleFormControInput1" placeholder="電話" name="rPhone"
									value="<%=request.getParameter("rPhone")%>">
							</div>
							<div class="mb-3">
								<label for="exampleFormControInput1" class="form-label">圖片</label>
								<input type="text" class="form-control"
									id="exampleFormControInput1" placeholder="圖片" name="rPicture"
									value="<%=request.getParameter("rPicture")%>" />
							</div>
