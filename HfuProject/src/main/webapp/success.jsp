...
<body>
	...
	<div class="col-sm-2 sidenav">
		<nav class="nav-left">
			<ul>
				<li><a href="#" class="logo"> <img src="images/p1.jpg">
						<span class="nav-item">會員</span>
				</a></li>
				<li><a href="#"> <i class="fas fa-menorah"></i> <span
						class="nav-item">餐廳</span>
				</a></li>
				<li><a href="#"> <i class="fas fa-comment"></i> <span
						class="nav-item">信息</span>
				</a></li>
				<li><a href="#"> <i class="fas fa-database"></i> <span
						class="nav-item">資料</span>
				</a></li>
				<li><a href="#"> <i class="fas fa-chart-bar"></i> <span
						class="nav-item">統計</span>
				</a></li>
				<li><a href="#"> <i class="fas fa-cog"></i> <span
						class="nav-item">設定</span>
				</a></li>

				<li><a href="admin/loginadmin.jsp" class="login"> <i
						class="fas fa-sign-out-alt"></i> <span class="nav-item">登入</span>
				</a></li>
			 	<a href="#" class="Top"><i class="fa-solid fa-arrow-up"></i> <span class="nav-item">回最上方
							</span>
				</a>
